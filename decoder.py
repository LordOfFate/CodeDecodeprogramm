class list:
    ...
    class node:
        ...
        def __init__(self, element, next_element = None, oneAddElement = None, zeroAddElement = None):
            self.element = element
            self.next_element = next_element
            self.oneAddElement = oneAddElement
            self.zeroAddElement = zeroAddElement
    ...
    def addChain(self, element, ChainZeroElement, ChainOneElement):
        current = self.head
